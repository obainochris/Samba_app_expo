...
const menu = [{ label: 'Personal details', icon: 'user' as const }, { label: 'Saved providers', icon: 'heart' as const }, { label: 'Payment methods', icon: 'credit-card' as const }, { label: 'Help & support', icon: 'help-circle' as const }];
